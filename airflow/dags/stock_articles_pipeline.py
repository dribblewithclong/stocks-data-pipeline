...
from data_ingest import StockArticleIngest


@dag(
    dag_id='stock_article_ingestion',
...
def stock_article_ingest():
    ...
    for symbol in [
        ...
        def transform(symbol, raw_data, **kwargs):
            ...
            transformed_data = StockArticleIngest(
                symbol,
                from_time,
                from_time,
