...
from data_ingest import StockTwitterIngest


@dag(
    dag_id='twitter_sentiment_ingestion',
...
def twitter_sentiment_ingest():
    ...
    for symbol in [
        ...
        def transform(symbol, raw_data, **kwargs):
            ...
            transformed_data = StockTwitterIngest(
                symbol,
                from_time,
                to_time,
